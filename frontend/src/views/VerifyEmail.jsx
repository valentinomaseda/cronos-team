          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            {estado === 'verificando' && (
              <>
                ...
                <p className="text-base sm:text-lg text-gray-500">Verificando tu email...</p>
              </>
            )}
            ...
            {estado === 'exito' && (
              <>
                ...
                <div className="text-center space-y-4 w-full">
                  <p className="text-lg sm:text-xl font-bold text-text-dark">¡Email Verificado!</p>
                  <p className="text-sm sm:text-base text-gray-500">{mensaje}</p>
                  <button
                    onClick={() => navigate('/login')}
                    className="w-full mt-4 px-6 py-3 bg-primary text-white rounded-lg hover:opacity-90 active:scale-95 transition-all font-semibold"
                  >
                    Ir al Login
                  </button>
                </div>
            ...
            {estado === 'error' && (
              <>
                ...
                <div className="text-center space-y-3 w-full">
                  <p className="text-lg sm:text-xl font-bold text-text-dark">Error de Verificación</p>
                  <p className="text-sm sm:text-base text-gray-500 px-2">{mensaje}</p>
                  ...
                  <div className="flex flex-col space-y-2 sm:space-y-3 mt-4 sm:mt-6 w-full px-2">
                    <button
                      ...
                      disabled={enviandoDeNuevo}
                        className="flex items-center justify-center space-x-2 bg-primary hover:opacity-90 text-white font-bold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 text-sm sm:text-base"
                    >
                      {enviandoDeNuevo ? (
                    ...
                    <button
                      onClick={() => navigate('/login')}
                      className="bg-primary hover:opacity-90 text-white font-bold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg transition-all duration-200 active:scale-95 text-sm sm:text-base"
                    >
                      Ir al Login
                    </button>
                  </div>
